...
class PaymentMethodDisplayedTest extends TestCase
{
    ...
    public function testPaymantMethodDisplayedOnTotalField()
    {
        var_dump("*****1st_Method:testPaymantMethodDisplayedOnTotalField");
        $users =
            [
                [
                    'name' => 'cat',
        ...
        $response = $this->post('/stripe', [
            ...
            'delivery_address' => '〒1234567 東京都渋谷区1-1-1 ビル名',
            'price' => $item->price,
            'item_id' => $item->id,
            'email' => $user->email,
        ]);
